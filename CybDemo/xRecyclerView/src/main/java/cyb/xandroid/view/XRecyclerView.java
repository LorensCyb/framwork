...
import cyb.xandroid.view.xrecyclerview.ArrowRefreshHeader;
import cyb.xandroid.view.xrecyclerview.LoadingMoreFooter;
...
public class XRecyclerView extends RecyclerView {
    ...
    /**
     * 设置刷新的进度条样式;具体查看{@link ProgressStyle}
     *
     * @param style 进度条样式值{@link ProgressStyle}
     */
    ...
    /**
     * 设置加载更多的进度条样式;具体查看{@link ProgressStyle}
     *
     * @param style 进度条样式值{@link ProgressStyle}
     */
...
//        }
     ...
     *
     * */
    public abstract static class XAdapter<T, VH extends RecyclerView.ViewHolder>
        ...
        public View layoutInflater(int layout) {
        ...
        public void addList(List<T> list, int position) {
            if (list != null) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    this.mList.add(position++, list.get(i));
                }
            }
