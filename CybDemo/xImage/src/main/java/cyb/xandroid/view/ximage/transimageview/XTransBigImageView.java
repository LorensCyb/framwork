...
public class XTransBigImageView extends ImageView {
    private Context mContext;
    private float tX, tY, sX, sY;
    private static long time1;
    private static long lastClickTime1;

    public XTransBigImageView(Context context) {
        super(context);
        this.mContext = context;
        setVisibility(GONE);
    }

    public XTransBigImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        setVisibility(GONE);
    }

    public XTransBigImageView(Context context, AttributeSet attrs, int defStyleAttr) {
