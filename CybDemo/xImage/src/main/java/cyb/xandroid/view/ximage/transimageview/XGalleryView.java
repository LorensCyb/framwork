...
public class XGalleryView extends ViewGroup {
    ...
    public XGalleryView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
    }

    public XGalleryView(Context context, AttributeSet attrs, int defStyleAttr) {
