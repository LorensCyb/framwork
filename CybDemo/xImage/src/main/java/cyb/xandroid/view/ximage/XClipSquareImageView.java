...
public class XClipSquareImageView extends ImageView implements View.OnTouchListener, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public XClipSquareImageView(Context context, AttributeSet attrs) {
        super(context, attrs);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.XClipSquareImageView);
        setBorderDistance((int) a.getDimension(R.styleable.XClipSquareImageView_borderDistance, 50));
        setBorderWidth((int) a.getDimension(R.styleable.XClipSquareImageView_borderWidth, 2));
        setBorderColor(a.getColor(R.styleable.XClipSquareImageView_borderColor, Color.WHITE));
        setOutsideColor(a.getColor(R.styleable.XClipSquareImageView_outsideColor, Color.parseColor("#76000000")));
        a.recycle();
