...
public class XTransSmallImageView extends ImageView {
    ...
    public XTransSmallImageView(Context context) {
        super(context);
        this.mContext = context;
        init();
    }

    public XTransSmallImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        init();
    }

    public XTransSmallImageView(Context context, AttributeSet attrs, int defStyleAttr) {
