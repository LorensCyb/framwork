package cyb.xandroid.view.ximage.transimageview;
 ...
 */
public class XBigImagePreview extends RelativeLayout {

    private Context mContext;
    private XGalleryView galleryView;
    private ViewPager pager;
    private XTransSmallImageView mTransSmallImageView;
    private XTransBigImageView transBigImageView;
    ...
    public XBigImagePreview(Context context) {
        super(context);
        this.mContext = context;
        findView();
    }

    public XBigImagePreview(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        findView();
    }

    public XBigImagePreview(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void findView() {
        ...
        galleryView = (XGalleryView) preview.findViewById(R.id.gallery);
        pager = (ViewPager) preview.findViewById(R.id.preview_viewPager);
        mTransSmallImageView = (XTransSmallImageView) preview.findViewById(R.id.transImage);
        ...
        transBigImageView = (XTransBigImageView) preview.findViewById(R.id.transBigImage);
    }
    ...
    public void init(final List<?> list, List<Integer> widthList, List<Integer> heightList,
        ...
        mTransSmallImageView.setExitEnd(new XTransSmallImageView.ExitEnd() {
            @Override
            public void end() {
                previewParent.setVisibility(GONE);
            }
        });
        galleryView.setItemClickListener(new XGalleryView.ItemClickListener() {
            @Override
        ...
        //Gallery加载更多的回调事件
        galleryView.setLoadMoreClick(new XGalleryView.LoadMoreClick() {
            @Override
            public void load() {
                if (mLoadMore != null) {
                    mLoadMore.loadMore();
    ...
    private void galleryItemClick(final int x, final int y, final float width, final float height, final int position) {
        ...
        transBigImageView.setTransEnd(new XTransBigImageView.TransEnd() {
            @Override
            public void end() {
