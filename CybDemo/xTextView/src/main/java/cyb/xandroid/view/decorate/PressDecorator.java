...
package cyb.xandroid.view.decorate;
...
public class PressDecorator extends XTextView.Decorator {
  ...
  public PressDecorator(int pressBgColor) {
  ...
  public XTextView.Decorator setPressTextColor(int pressTextColor) {
    this.pressTextColor = pressTextColor;
    return this;
  }

  public XTextView.Decorator setPressBgColor(int pressBgColor) {
    this.pressBgColor = pressBgColor;
    return this;
  }
