...
package cyb.xandroid.demo.view.xtextview.decorator;
...
public class Ripple2Decorator extends XTextView.Decorator {
    ...
    public Ripple2Decorator(int rippleColor) {
    ...
    @Override
    protected void decorate(XTextView v, Canvas canvas) {
