...
import cyb.xandroid.util.SystemUtil;

public class SystemUtilActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            phone = (TelephonyManager) getApplicationContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    private void init() {
        ...
        //手机版本号
        setEditText(R.id.osVersion, SystemUtil.PHONE_VERSION());
        ...
        setEditText(R.id.model, SystemUtil.MODEL());
