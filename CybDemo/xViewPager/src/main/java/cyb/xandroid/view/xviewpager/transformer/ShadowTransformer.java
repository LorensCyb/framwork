package cyb.xandroid.view.xviewpager.transformer;
...
public class ShadowTransformer implements XZoomViewPager.OnPageChangeListener, XZoomViewPager.PageTransformer {
    ...
    public ShadowTransformer(XZoomViewPager viewPager, ICardAdapter adapter) {
